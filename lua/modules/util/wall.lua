...
local function MeasureThickness(params)
	...
	local filterEnts = params.filterEnts
...
--- @return table
local function GetWallInfoAlongLine(attacker, victim, attackerPos, victimPos, prxoy)
	local walls = {}
	...
	local iter = 0
	local filterEnts = { attacker, victim, prxoy }
